    ...
    <main >
      <div>
        ...
        <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 mt-5 mb-5">
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/logos/mcc-black.png" alt="multichaincapital.eth Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            ...
            <div>
              <div className="flex -mt-px divide-x divide-gray-200">
                <div className="flex flex-1 w-0">
                  <a target="_blank" rel="noopener noreferrer" href="https://etherscan.io/address/0xfef02f8b3fb7546e362a58442e45cd1c9604ea01" className="relative inline-flex items-center justify-center flex-1 w-0 py-4 -mr-px text-sm font-medium text-gray-700 border rounded-bl-lg hover:text-gray-500">
                    <img className="flex-shrink-0 w-5 h-5" src="/networks/eth.png" alt="Ethereum Image" title="etherscan" />
                  </a>
                </div>
              </div>
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/logos/chef.png" alt="multichaincapital incubations Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/logos/mcc-multinodes.png" alt="multichaincapital.eth Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/logos/mcc-multinodes.png" alt="multichaincapital nodes Image" />
        ...
        <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 mt-5 mb-5">
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/logos/mcc-black.png" alt="multichaincapital Image" />
        ...
        <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 mt-5 mb-5">
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/aa.png" alt="Andre Anonymous Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/cashback.png" alt="Cash Back Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/czr.png" alt="CZ Retirement Package Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/fnd.png" alt="Friday Night Degen Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/gold.png" alt="gold Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/ogtshare.png" alt="OG-TSHARE Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/ogtbond.png" alt="OG-TBOND Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/rc.png" alt="RC Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/reuro.png" alt="Reflective EURO Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/slvr.png" alt="silver Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/sales.png" alt="Sales Tax Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/merge.png" alt="TheMerge Tech Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/ub.png" alt="Unit Bias Image" />
          ...
          <li className=" border-white col-span-1 flex flex-col rounded-lg border-4 bg-white text-center shadow">
            <div className="flex flex-col flex-1 px-4 py-3">
              <img className="flex-shrink-0 w-auto h-32 mx-auto rounded-lg" src="/incubators/uub.png" alt="Ultra Unit Bias Image" />
